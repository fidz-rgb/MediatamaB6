...
$users = mysqli_query($connect, "SELECT * FROM users WHERE role != 'admin'");
?>

<!-- Tabel Users -->
<div class="container">
  <table id="datatablesSimple" class="table table-bordered mx-auto" style="width:950px;">
      ...
      ?>
        <tr>
          ...
          <td class="" style="width: fit-content;">
            <?= ($item['role'] == 'admin') ? 'Super User' : (($item['role'] == 'user') ? 'User Normal' : (($item['is_approved'] == 1) ? 'Approved' : 'Pending')); ?>
          </td>
